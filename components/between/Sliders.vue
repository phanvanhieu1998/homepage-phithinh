      ...
      <el-carousel-item v-for="(item, index) in listSliders" :key="item.id">
        <div class="container">
            ...
            <div class=" slider__content ">
              <h2 class="ml9">
                <span class="text-wrapper ">
                  <span style="color:white" class="letters"
                    >THỜI TRANG NỮ 2021</span
                  >
                </span>
              </h2>
          ...
          <div class="slider" v-if="index == 1">
            <div class="slider__content">
              <span data-aos-duration="3000" style="margin-left:10px"
                >Cá Tính, Trẻ Trung 2021</span
              >
              <el-button
                data-aos="fade-down"
                data-aos-duration="3000"
        ...
        <el-image style="width: 100%; height: 100%" :src="item.images">
        </el-image>
      </el-carousel-item>
    </el-carousel>
